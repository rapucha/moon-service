...
public final class MoonScoringPrototype {
    ...
    private static String usage() {
        return String.join(System.lineSeparator(),
                "Usage:",
                "  mvn -q org.codehaus.mojo:exec-maven-plugin:3.3.0:java -Dexec.mainClass=dev.moonservice.scoringprototype.MoonScoringPrototype -Dexec.args=\"[options]\"",
                "  mvn -q org.codehaus.mojo:exec-maven-plugin:3.3.0:java -Dexec.mainClass=dev.moonservice.scoringprototype.MoonScoringPrototype -Dexec.args=\"--request fixtures/prague-preview-request.json\"",
                "",
                "Options:",
