...
- `docs/api-shape.md`: intended first web/API shape.
- `backend/src/test/java/...`: executable backend HTTP behavior.
- `prototypes/spring-preview/`: retained HTTP contract reference.
- `prototypes/jvm-scoring/fixtures/`: fixture request examples.
...
2. Update design docs first or alongside implementation.
   - Update `docs/api-shape.md` for public contract decisions.
   - Update README/module docs if commands or endpoint examples change.
...
5. Validate.
   ...
   - Additional prototype parity checks if scoring output changed.
   - `git diff --check`
